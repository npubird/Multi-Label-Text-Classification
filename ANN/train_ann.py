    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            with tf.control_dependencies(tf.get_collection(tf.GraphKeys.UPDATE_OPS)):
                ...
                grads_and_vars = optimizer.compute_gradients(ann.loss)
                train_op = optimizer.apply_gradients(grads_and_vars, global_step=ann.global_step, name="train_op")
            ...
            def validation_step(x_validation, y_validation, y_validation_bind, writer=None):
                ...
                for batch_validation in batches_validation:
                    ...
                    step, summaries, logits, cur_loss = sess.run(
                        [ann.global_step, validation_summary_op, ann.logits, ann.loss], feed_dict)
