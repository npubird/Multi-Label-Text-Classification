        ...
        with sess.as_default():
            ...
            with tf.control_dependencies(tf.get_collection(tf.GraphKeys.UPDATE_OPS)):
                learning_rate = tf.train.exponential_decay(learning_rate=FLAGS.learning_rate,
                                                           global_step=mann.global_step, decay_steps=FLAGS.decay_steps,
                ...
                train_op = optimizer.apply_gradients(zip(grads, vars), global_step=mann.global_step, name="train_op")
            ...
            def validation_step(x_validation, y_validation, writer=None):
                ...
                for batch_validation in batches_validation:
                    ...
                    step, summaries, scores, cur_loss = sess.run(
                        [mann.global_step, validation_summary_op, mann.scores, mann.loss], feed_dict)
