...
from text_mann import TextMANN
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            with tf.control_dependencies(tf.get_collection(tf.GraphKeys.UPDATE_OPS)):
                ...
                grads_and_vars = optimizer.compute_gradients(mann.loss)
                train_op = optimizer.apply_gradients(grads_and_vars, global_step=mann.global_step, name="train_op")
            ...
            # acc_summary = tf.summary.scalar("accuracy", mann.accuracy)
            ...
            def validation_step(x_validation, y_validation, y_validation_bind, writer=None):
                ...
                for batch_validation in batches_validation:
                    ...
                    step, summaries, logits, cur_loss = sess.run(
                        [mann.global_step, validation_summary_op, mann.logits, mann.loss], feed_dict)
